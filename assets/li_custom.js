document.addEventListener("alpine:init", () => {
  ...
  // Note: add-to-cart buttons are wired via Alpine bindings generated by the converter

  // Debug: automatic logging for add-to-cart interactions
  ...
  // Debug: observe add-to-cart lifecycle CustomEvents
  try {
    window.addEventListener("li:addtocart", (e) => {
      console.info("Liquify - debug: li:addtocart event", e.detail);
    });
  } catch (_) {}
});
