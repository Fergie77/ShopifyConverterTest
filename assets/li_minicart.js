document.addEventListener("alpine:init", () => {
  // Add a global listener to debug the toggleminicart event
  window.addEventListener("toggleminicart", (e) => {
    console.log("🌍 GLOBAL: toggleminicart window event received!", e);
  });

  Alpine.data("handleMinicart", () => ({
    init() {
      console.log("🚀 handleMinicart() initialized");
      console.log("🔗 Event listeners should be attached now");
      // Test: add a manual listener to verify events work
      window.addEventListener("toggleminicart", (e) => {
        console.log("👂 MANUAL LISTENER: toggleminicart event heard in init!");
      });
      // Load cart on init
      this.getCart();
    },
    ...
    toggleMiniCart() {
      console.log("🎯 toggleMiniCart() called in li_minicart.js");
      console.log("🔍 About to call LiquifyHelper.handleTriggerClick()");
      LiquifyHelper.handleTriggerClick();
      console.log("🔄 About to call getCart()");
      this.getCart();
      console.log("✅ toggleMiniCart() completed");
    },
     ...
     */
    set open(open) {
      // deprecated use  LiquifyHelper instead
